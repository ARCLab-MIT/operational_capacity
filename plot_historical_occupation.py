...
for year in range(start_year, end_year):
    ...
    data = read_csv('data/collision_results_historical_' + str(year) + '.csv')
    ...
    if collision_550 == True:
        annual_occupation_550.append(sum_conj_freq[i])
    else:
        annual_occupation_550.append(0)
    print("fake starlink {annual_occupation_550}")
    if collision_800 == True:
        annual_occupation_800.append(sum_conj_freq[i])
    else:
        annual_occupation_800.append(0)
    print(annual_occupation_800)
    if collision_900 == True:
        annual_occupation_900.append(sum_conj_freq[i])
    else:
        annual_occupation_900.append(0)
    print(annual_occupation_900)
    ...
    # Example usage
    filename = "data/Historical_TLE_Data/" + str(year) + "_no_repeats.txt"
  ...
  # Plot Heatmap
    ...
    heatmap_plot = plt.pcolormesh(xedges, yedges, heatmap.T, cmap=custom_cmap, shading='auto', vmin=vmin, vmax=vmax)
...
print(len(plot_years))
print(len(annual_occupation_550))
plt.figure()
plt.plot(plot_years, annual_occupation_550, label='550 km')
plt.xlabel('Year')
plt.ylabel('Annual Occupation')
plt.title('Annual Occupation at 550 km (Location of Starlink Constellation, First Launched in 2019)')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
...
plot_years = list(range(start_year, end_year))
print(len(plot_years))
print(len(annual_occupation_800))
plt.figure()
plt.plot(plot_years, annual_occupation_800, label='800 km')
plt.xlabel('Year')
plt.ylabel('Annual Occupation')
plt.title('Annual Occupation at 800 km (Location of Iridium-Cosmos Collision in 2009)')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
...
plot_years = list(range(start_year, end_year))
print(len(plot_years))
print(len(annual_occupation_900))
plt.figure()
plt.plot(plot_years, annual_occupation_900, label='900 km')
plt.xlabel('Year')
plt.ylabel('Annual Occupation')
plt.title('Annual Occupation at 900 km (Location of Chinese AntiSat Test in 2007)')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
